    ...
    return (
        <div className='content'>
            ...
            <div className='focus flex-child'>
                <input onKeyDown={enterHandler} className='focus-input' spellCheck='false' autoComplete='false'
                style={{display: removeFocusInput ? "none" : "block"}} />
            </div>
            ...
            <div className='focus-box' style={{display: removeFocusInput ? "block" : "none"}}>
                ...
                <div className='focus-box-item'>
                    <div>
                        <input onClick={strikeText} className='focus-item-checkbox' type='checkbox' checked={strike ? "checked" : ""}/>
                    </div>
                    <div onClick={strikeText} className='focus-item' style={{fontStyle: "italic", textDecoration: strike ? "line-through" : "none"}}> {focusItemText} </div>
