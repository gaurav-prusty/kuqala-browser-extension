...
function Content() {
    ...
    let [removeFocusInput, setRemoveFocusInput] = useState(false);
    let [focusItemText, setFocusItemText] = useState("");
    let [focusInputText, setFocusInputText] = useState("");
    ...
    function changeHandler(event) {
        setFocusInputText(event.target.value);
    }
    ...
    return (
        <div className='content'>
            ...
            <div className='focus flex-child'>
                <input onChange={changeHandler} onKeyDown={enterHandler} className='focus-input' spellCheck='false' autoComplete='false'
            ...
            <div className='focus-box' style={{display: removeFocusInput ? "block" : "none"}}>
                ...
                <div className='focus-box-item'>
                    <div>
                        <input onClick={strikeText} className='checkbox' type='checkbox' checked={strike ? "checked" : ""}/>
                    </div>
                    <div onClick={strikeText} className='focus-item user-select' style={{fontStyle: "italic", textDecoration: strike ? "line-through" : "none"}}> {focusItemText} </div>
                    <div onClick={editFocus} className='focus-edit'>
